# Remsnet Spec file for package fastforward
#
...
Patch:          %{name}-errno.h-diff
Patch1:         %{name}-%{version}.patch.2001020500
...
install -m 755 fastforward %{buildroot}/usr/bin/fastforward
...
%defattr(-,root,root)
%doc README INSTALL FILES ALIASES BLURB THANKS TODO SYSDEPS VERSION
